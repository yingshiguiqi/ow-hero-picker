...
import { DynamicRecommendPanel } from "@/components/DynamicRecommendPanel";
      ...
      <header className="bg-gradient-to-r from-slate-900 via-slate-900 to-slate-800 border-b-2 border-orange-500/30 sticky top-0 z-20">
        <div className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/counters"
              className="flex items-center gap-2 px-4 py-2 bg-slate-800/50 border border-orange-500/30 rounded hover:bg-slate-700/50 transition-colors"
            >
              <Swords className="w-4 h-4 text-orange-500" />
              <span className="text-sm font-medium text-white">克制关系</span>
            </Link>
